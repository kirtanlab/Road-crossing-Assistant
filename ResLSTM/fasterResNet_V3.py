...
for epoch in range(num_epochs):
        ...
        for batch in t:
            if len(batch['label']) == 320:
                if 'data' in batch:
                    ...
                    # print(features.shape) #80,960,1,1
                    ...
                    lstm_output = lstm_output.view(320)
                    labels = labels.view(320)
    ...
    if val_f1score > best_f1score:
        ...
        torch.save(state, "mobile_v3_v2_lstm.pt")
    state = {'net1':lstm_model.state_dict(),
                'net2':Linear.state_dict(),
                'optimizer':optimizer.state_dict()}
    torch.save(state,f"Epoch_{epoch + 1}_mobile_v3_v2.pt")
